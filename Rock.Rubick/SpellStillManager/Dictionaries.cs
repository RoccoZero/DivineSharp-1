...
namespace RockRubick
{
    internal sealed class Dictionaries
    {
        ...
        public static readonly Dictionary<AbilityId, int> SpellList = new Dictionary<AbilityId, int>
        {
            ...
            {AbilityId.rattletrap_power_cogs, 1},
            ...
            {AbilityId.dazzle_poison_touch, 1},
            ...
            {AbilityId.invoker_sun_strike, 2},
            {AbilityId.invoker_deafening_blast, 2},
            {AbilityId.invoker_emp, 2},
